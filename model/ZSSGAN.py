...
class ZSSGAN(torch.nn.Module):
    def __init__(self, args):
        ...
        self.generator_frozen = SG2Generator(args.frozen_gen_ckpt, img_size=args.size,
    ...
    def forward(
        ...
        with torch.no_grad():
            ...
            frozen_img = self.generator_frozen(w_styles, input_is_latent=True, truncation=truncation,
